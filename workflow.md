...
Esta línea guarda solamente su stock en `/Humor Argentino/Main/<temática>/`. Las otras líneas del repositorio tienen carpetas e inventarios propios: `/Humor Argentino/Experimental` y `/Humor Argentino/Secuencias-post`. No contar ni reclasificar archivos de esas líneas. La automatización de main conserva su ejecución horaria y no ejecuta branches.
