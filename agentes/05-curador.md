...
## Momento y fuente
Tras generación, inspección y guardado; Biblioteca `/Humor Argentino/Secuencias-post/` y los manifiestos de este branch.
...
2. Mantener los cuatro archivos individuales, numerados 01–04, en `/Humor Argentino/Secuencias-post/<tema>/<id>/`. Crear carpeta cuando haga falta y confirmar rutas.
